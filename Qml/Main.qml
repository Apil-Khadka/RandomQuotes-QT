...
ApplicationWindow {
    ...
    // For "Default", light mode uses a darker green and dark mode a lighter green.
    ...
    Column {
        ...
        Rectangle {
            ...
            Text {
                id: quoteText
                text: quoteGen.currentQuote    // Ensure quoteGen is defined.
            ...
            Button {
                id: copyButton
                text: "📋"  // clipboard-like symbol
                anchors.bottom: parent.bottom
                anchors.right: parent.right
                anchors.margins: 10
                background: Rectangle {
                    color: hovered ? hoverColor : buttonColor
                    radius: 5
                }
                onClicked: {
        ...
        Text {
            id: authorText
            text: "- " + quoteGen.currentAuthor  // Ensure quoteGen.currentAuthor exists.
            font.family: selectedFont === "Default" ? Qt.application.font.family : selectedFont
        ...
        Row {
            ...
            Button {
                text: "←"
                onClicked: quoteGen.previousQuote()   // Ensure method exists.
                background: Rectangle {
                    color: hovered ? hoverColor : buttonColor
                    radius: 5
                }
            ...
            Button {
                text: "Generate"
                onClicked: quoteGen.generateQuote()   // Ensure method exists.
                background: Rectangle {
                    color: hovered ? accentColor.lighter(120) : accentColor
                    radius: 5
                }
                font.bold: true
                font.family: selectedFont === "Default" ? Qt.application.font.family : selectedFont
            ...
            Button {
                text: "→"
                onClicked: quoteGen.nextQuote()   // Ensure method exists.
                background: Rectangle {
                    color: hovered ? hoverColor : buttonColor
                    radius: 5
                }
        ...
        Row {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    // Update all dependent properties when dark mode is toggled.
                    backgroundColor = isDarkMode ? "#263238" : "#E8F5E9";
                    cardColor = isDarkMode ? "#37474F" : "#FFFFFF";
                    borderColor = isDarkMode ? "#78909C" : "#B0BEC5";
                    accentColor = isDarkMode ? "#66BB6A" : "#43A047";
                    buttonColor = isDarkMode ? "#558B2F" : "#8BC34A";
                    hoverColor = isDarkMode ? "#689F38" : "#AED581";
    ...
    Popup {
        ...
        width: Math.max(300, mainWindow.width * 0.5)
        height: Math.max(350, mainWindow.height * 0.6)
        anchors.centerIn: parent
        background: Rectangle {
            radius: 10
            color: cardColor
    ...
    // ---------------------------
    // Snackbar-like "Copied to Clipboard" Message
    // ---------------------------
    Rectangle {
        id: copiedMessage
        visible: false
    ...
    // ---------------------------
    // Responsive Adjustments using Util.js
    // ---------------------------
    onWidthChanged: {
        Util.updateLayout(mainWindow, mainColumn);
    }
    onHeightChanged: {
        Util.updateLayout(mainWindow, mainColumn);
    }
